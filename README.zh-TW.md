...
目前為未簽章測試版，Windows 可能提示「未知發行者」。[簽章進度](docs/CODE-SIGNING.md)

[遇到問題](docs/TROUBLESHOOTING.md) · [隱私與移除](docs/PRIVACY.md) · [開發者／AI 文件](docs/DEVELOPERS.md) · [MIT 授權](LICENSE)
